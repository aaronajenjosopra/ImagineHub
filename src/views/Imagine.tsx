        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-300">
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="font-bold text-zinc-400 uppercase tracking-widest text-[10px]">Imagene Hub</span>
            </div>
          </div>
          ...
          <article className="py-8">
            <header className="mb-12">
              ...
              <h1 className="text-5xl md:text-6xl font-black tracking-tight leading-tight mb-8">{selectedPost.titulo}</h1>
          ...
          <footer className="py-16 border-t border-zinc-100 mt-12">
